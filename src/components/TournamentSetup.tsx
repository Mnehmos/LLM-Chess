...
const TOP_MODELS: Record<LLMProvider, { model: string; name: string }[]> = {
  openrouter: [
    ...
    { model: 'openai/gpt-5.4-mini', name: 'GPT-5.4 Mini' },
    { model: 'openai/gpt-5.4-nano', name: 'GPT-5.4 Nano' },
    ...
    { model: 'z-ai/glm-5-turbo', name: 'GLM-5 Turbo' },
    ...
    { model: 'minimax/minimax-m2.7', name: 'MiniMax M2.7' },
    ...
    { model: 'mistralai/mistral-small-2603', name: 'Mistral Small 2603' },
