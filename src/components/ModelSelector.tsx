...
const FEATURED_MODELS: Record<LLMProvider, LLMModel[]> = {
  openrouter: [
    ...
    { id: 'openai/gpt-5.4-mini', name: 'GPT-5.4 Mini', pricing: { prompt: '', completion: '' } },
    { id: 'openai/gpt-5.4-nano', name: 'GPT-5.4 Nano', pricing: { prompt: '', completion: '' } },
    ...
    { id: 'z-ai/glm-5-turbo', name: 'GLM-5 Turbo', pricing: { prompt: '', completion: '' } },
    ...
    { id: 'minimax/minimax-m2.7', name: 'MiniMax M2.7', pricing: { prompt: '', completion: '' } },
    ...
    { id: 'mistralai/mistral-small-2603', name: 'Mistral Small 2603', pricing: { prompt: '', completion: '' } },
